...
// ✅ Import product data
import productsData from "../data/indooroutdoorproducts.json";

// ✅ Main FeaturedProduct Component
const FeaturedCards = () => {
  ...
  return (
    <section className="discount-area p-relative section-space pt-0">
      <div className="container">
        <div className="section-title-wrapper-4 mb-40 text-center">
          <span className="section-subtitle-4 mb-10">top sale</span>
          <h2 className="section-title-4">Featured Product</h2>
        </div>
              ...
              <SwiperSlide key={`${item.id}`}>
                <div className="product-item furniture__product">
                  ...
                  <div className="product-thumb theme-bg-2">
                    <a href={`/productsdetails/featured/${item.id}`}>
                      <img
                  ...
                  <div className="product-content">
                    ...
                    <div className="product-price">
                      ...
                      <span className="product-new-price">₹{item.newPrice} Per Square Feet</span>
                    </div>
                  </div>
                </div>
              </SwiperSlide>
