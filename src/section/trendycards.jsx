...
const TrendyCards = () => {
   ...
   const products = trendyData.trendy;
      ...
      <div className="container">
        <div className="furniture-trendy__header">
          <div className="section-title-wrapper-4 mb-40">
            <span className="section-subtitle-4 mb-10">THIS MONTH</span>
            <h2 className="section-title-4">Trendy Collection</h2>
          </div>
        </div>
                  ...
                  >
                    <div className="product-item furniture__product">
                      ...
                      <div className="product-thumb theme-bg-2">
                        <a href={`/productsdetails/trendy/${item.id}`}>
                          <img
