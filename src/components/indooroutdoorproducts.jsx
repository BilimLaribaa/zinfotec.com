...
import indoorData from "../data/indooroutdoorproducts.json"; 
import outdoorData from "../data/indooroutdoorproducts.json"; 

const IndoorOutdoorProducts = ({ page }) => {
  const navigate = useNavigate(); // useNavigate hook
  const products = page === "indoor" ? indoorData.indoor : outdoorData.outdoor;
            ...
            {/* <div className="col-xxl-8 col-xl-8 col-lg-8 col-md-6">
              <div className="product__filter-wrapper d-flex flex-wrap gap-3 align-items-center justify-content-md-end mb-30">
                ...
                <div className="product__filter-count d-flex align-items-center">
                  <div className="btn-dropdown__options">
                    <select>
                      <option>Show 11</option>
                  ...
                  <div
                    className="bd-product__filter-style nav nav-tabs"
                    role="tablist"
                  >
                    <button
                ...
                <div className="product-item furniture__product">
                  {item.newPrice && (
                    <div className="product-badge">
                      {/* <span className="product-trending">
                        {Math.round(
                  ...
                  <div className="product-thumb theme-bg-2">
                    <a href={`/productsdetails/${page}/${item.id}`}>
                      <img
                    ...
                    {/* <div className="product-action-item">
                      <button type="button" className="product-action-btn">
                        ...
                        <span className="product-tooltip">Add to Cart</span>
                      </button>
                      <button
                        type="button"
                      ...
                      >
                        ...
                        <span className="product-tooltip">Quick View</span>
                      </button>
                      <button type="button" className="product-action-btn">
                        <svg
                          width="21"
                        ...
                        <span className="product-tooltip">Add To Wishlist</span>
                      </button>
                    </div> */}
                  </div>
                  ...
                  <div className="product-content">
                    ...
                    <div className="product-price">
                      {/* Conditional clickable price */}
                      {item.newPrice === "inquiry for price" ? (
                        <span
